...
const ThemeManager = {
        ...
        themeButtons.forEach(button => {
            ...
            button.addEventListener('click', () => {
                if (this.getAutoMode() !== this.AUTO_MODES.OFF) {
                    this.showThemeChangeNotification(currentTheme, 'Desative o modo automático para escolher manualmente');
                    return;
                }
    ...
    updateThemeButtonsState() {
        ...
        themeButtons.forEach(button => {
            button.disabled = autoEnabled;
            button.classList.toggle('disabled', autoEnabled);
        });
    },
