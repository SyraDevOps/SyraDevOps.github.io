...
const PWA_VALIDATOR = {
    ...
    checkIcons() {
        ...
        this.test('Ícone 192px', () => {
            return document.querySelector('link[rel="icon"][sizes="192x192"]') !== null ||
                   document.querySelector('link[rel="icon"][href*="192"]') !== null;
        });

        this.test('Ícone 512px', () => {
            return document.querySelector('link[rel="icon"][sizes="512x512"]') !== null ||
                   document.querySelector('link[rel="icon"][href*="512"]') !== null;
        });
        ...
        this.test('Ícone SVG disponível', () => {
            return document.querySelector('link[rel="icon"][href*=".svg"]') !== null;
        });
    },
